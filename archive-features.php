<?php get_header(); ?>
	...
	<div class="row">
		...
		<div class="col-lg-7">
			...
			<div id="carousel-features" class="carousel slide" data-interval="5000" data-ride="carousel">
              <!-- Indicators -->
              <ol class="carousel-indicators">
                <?php for ($i = 1; $i <= $total; $i++) { ?>
                    <li data-target="#carousel-features" data-slide-to="<?php echo $i-1; ?>" <?php if($i == 1){ ?>class="active"<?php } ?>></li>
                <?php } ?>
              </ol>
  ...
  <a class="right carousel-control" href="#carousel-features" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
		...
		<div class="col-lg-5">
			...
			<h3 class="center toc-head">The Latest Features</h3>
